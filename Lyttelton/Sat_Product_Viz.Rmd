...
3. [Conclusion and further Work](#conclusion)
...
* Because the sat data is available from 07/2002 to 03/2019, to define a time frame to refine the dataset within. Use the surveys dates, maybe to focus on ecological data during the baseline period (19-20/01/17 BL1 to 5-8/12/17 BL3) and do another analysis with the data after dredging phase (DP1 only date to fell into sat data dataset range).
